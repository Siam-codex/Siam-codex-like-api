# SIAM LIKE API SRC UID PASSWORD 
...
def reset_cache():
    ...
    global liked_cache
    liked_cache.clear()
    return jsonify({"message": "Cache cleared", "credit": "@SIAM_CODEX"})
...
if __name__ == '__main__':
    ...
    # Render বা ক্লাউড প্ল্যাটফর্মের পোর্ট স্বয়ংক্রিয়ভাবে নেওয়ার জন্য এটি ব্যবহার করুন
